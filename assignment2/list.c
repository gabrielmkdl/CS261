...
/*
 * This function returns a 1 if the list is empty and a 0 if it isn't empty 
 *
 * Params:
 *   list - the linked list that is being checked if it's empty or not. 
 */
...
/*
 * This function returns the value of the head node
 *
 * Params:
 *   list - the linked list that we want the head node's value of. May not be NULL
 */
void* get_head_val(struct list* list) {
